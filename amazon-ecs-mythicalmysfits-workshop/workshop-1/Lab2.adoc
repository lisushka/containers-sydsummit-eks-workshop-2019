...
< Date: Mon, 08 Apr 2019 12:19:02 GMT message: 
Nothing here, used for health check. Try /mysfits instead.    
...
Now that we have our containers deployed to Amazon EKS we can continue with the workshop. Go https://github.com/kmhabib/containers-sydsummit-eks-workshop-2019/blob/master/amazon-ecs-mythicalmysfits-workshop/README.md[back] and start lab 3. 